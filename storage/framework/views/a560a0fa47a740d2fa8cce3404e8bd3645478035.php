...
<?php $__env->startSection('action-button'); ?>
    <div class="all-button-box row d-flex justify-content-end">
        ...
        <?php endif; ?>
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <a href="<?php echo e(route('event.export')); ?>" class="btn btn-xs btn-white btn-icon-only width-auto">
        ...
        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
            <div class="all-button-box">
                <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto"
                    data-url="<?php echo e(route('event.file.import')); ?>" data-ajax-popup="true"
                    data-title="<?php echo e(__('Import event CSV file')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jaysecurity\resources\views/event/index.blade.php ENDPATH**/ ?>