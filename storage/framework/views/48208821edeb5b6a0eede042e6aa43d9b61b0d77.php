        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php if(count($get_section) > 0): ?>
                    <?php $__currentLoopData = $get_section; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($value->content == "" || $value->content == null): ?>
                            <img src="<?php echo e(asset('storage/uploads/Landing_page_component_image')); ?>/<?php echo e($value->section_demo_image); ?>" onclick="set_section_page('<?php echo e($value->id); ?>')" id="component_modal_<?php echo e($value->id); ?>">
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            </div>
...
<?php /**PATH /home3/jaysecurity/sms.jaysecurity.in/resources/views/custom_landing_page/index.blade.php ENDPATH**/ ?>