...
<ul class="navbar-nav navbar-nav-docs">
    ...
    <?php if(Gate::check('Manage Employee')): ?>
        ...
        <?php else: ?>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('employee-field.index')); ?>" class="nav-link  <?php echo e((Request::route()->getName() == 'employee-field.index') ||  (Request::route()->getName() == 'employee-field.create') ||  (Request::route()->getName() == 'employee-field.edit') ||  (Request::route()->getName() == 'employee-field.show') ? 'active' : ''); ?>">
                    <i class="fas fa-users"></i><?php echo e(__('Employee Field')); ?>

                </a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('salary.index')); ?>" class="nav-link  <?php echo e((Request::route()->getName() == 'salary.index') ||  (Request::route()->getName() == 'salary.create') ||  (Request::route()->getName() == 'salary.edit')  ? 'active' : ''); ?>">
                    <i class="fas fa-users"></i><?php echo e(__('Salary')); ?>
    ...
    <?php if(\Auth::user()->type=='super admin'): ?>
        <li class="nav-item">
            <a href="<?php echo e(route('plan_requests.index')); ?>" class="nav-link <?php echo e(request()->is('plan_requests*') ? 'active' : ''); ?>">
    ...
    <?php endif; ?>
    <?php if(Gate::check('Manage Department') || Gate::check('Manage Designation')  || Gate::check('Manage Document Type')  || Gate::check('Manage Branch') ||
    Gate::check('Manage Company') ||
    Gate::check('Manage Company Unit') ||
    Gate::check('Manage Award Type') || Gate::check('Manage Termination Types')|| Gate::check('Manage Payslip Type') || Gate::check('Manage Allowance Option') || Gate::check('Manage Loan Options')  || Gate::check('Manage Deduction Options') || Gate::check('Manage Expense Type')  || Gate::check('Manage Income Type') || Gate::check('Manage
...
'job-stage.index') ? 'show' : ''); ?>"
                 id="navbar-constant">
                <ul class="nav flex-column submenu-ul">
                    <li class="nav-item <?php echo e(request()->is('emp-role*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('emp-role.index')); ?>"><?php echo e(__('Employee Role')); ?></a>
                        </li>
                    ...
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Company')): ?>
                        <li class="nav-item <?php echo e(request()->is('company*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('company.index')); ?>"><?php echo e(__('Company')); ?></a>
                        </li>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Company Unit')): ?>
                        <li class="nav-item <?php echo e(request()->is('company-unit*') ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('company-unit.index')); ?>"><?php echo e(__('Company Unit')); ?></a>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH /Users/mostofa/Desktop/Upwork/jaysecurity/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>