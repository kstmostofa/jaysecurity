...
@section('content')
<div class="row">
{{ Form::model($salary, array('route' => array('salary.update', $salary->id), 'method' => 'PUT' , 'enctype' => 'multipart/form-data')) }}
@csrf
</div>
<div class="row">
<div class="col-md-6 ">
...
<div class="row">
    ...
    <div class="form-group  col-lg-6 col-md-6">
                ...
                {!! Form::select('role', $roles, $salary->role_id,array('class' => 'form-control select2','required'=>'required')) !!}
                @error('role')
        ...
        <div class="form-group ">
            ...
            <div class="d-flex radio-check">
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="active_" value="1" name="is_active" class="custom-control-input" {{($salary->is_active == '1')?'checked':''}}>
                    <label class="custom-control-label" for="active_">{{__('Active')}}</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="active_not" value="0" name="is_active" class="custom-control-input" {{($salary->is_active == '0')?'checked':''}}>
    ...
    <div class="form-group col-md-6">
       <!--  {!! Form::label('Start Date', __('Start Date'),['class'=>'form-control-label']) !!}<span class="text-danger pl-1">*</span> -->
            {!! Form::hidden('start_date', old('start_date'), ['class' => 'form-control datepicker']) !!}
    </div>
...
<div class="row">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
        ...
        {{ Form::select('company_client_unit_id', $company_client_unit,null, array('class' => 'form-control  select2','id'=>'company_client_unit_id','required'=>'required')) }}
    </div>
   <div class="form-group col-md-6">
