...
<ul class="navbar-nav navbar-nav-docs">
    ...
    @if(Gate::check('Manage Employee'))
        ...
        @else
            ...
            <li class="nav-item">
                <a href="{{route('employee-field.index')}}" class="nav-link  {{ (Request::route()->getName() == 'employee-field.index') ||  (Request::route()->getName() == 'employee-field.create') ||  (Request::route()->getName() == 'employee-field.edit') ||  (Request::route()->getName() == 'employee-field.show') ? 'active' : '' }}">
                    <i class="fas fa-users"></i>{{ __('Employee Field') }}
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('salary.index')}}" class="nav-link  {{ (Request::route()->getName() == 'salary.index') ||  (Request::route()->getName() == 'salary.create') ||  (Request::route()->getName() == 'salary.edit')  ? 'active' : '' }}">
                    <i class="fas fa-users"></i>{{ __('Salary') }}
                </a>
            </li>
        @endif
    @endif
    ...
    @endif
    @if(Gate::check('Manage Department') || Gate::check('Manage Designation')  || Gate::check('Manage Document Type')  || Gate::check('Manage Branch') ||
...
'job-stage.index') ? 'show' : '' }}"
                 id="navbar-constant">
                <ul class="nav flex-column submenu-ul">
                    <li class="nav-item {{ request()->is('emp-role*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('emp-role.index') }}">{{ __('Employee Role') }}</a>
                        </li>
                    @can('Manage Branch')
                    ...
                    @endcan
                    @can('Manage Company Unit')
                        <li class="nav-item {{ request()->is('company-unit*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('company-unit.index') }}">{{ __('Company Unit') }}</a>
                        </li>
                    @endcan
